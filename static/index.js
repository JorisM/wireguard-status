(() => {
  ...
  var decodeJson2 = /* @__PURE__ */ decodeJson(/* @__PURE__ */ decodeArray2(/* @__PURE__ */ decodeRecord(/* @__PURE__ */ gDecodeJsonCons(/* @__PURE__ */ decodeFieldId(/* @__PURE__ */ decodeRecord(/* @__PURE__ */ gDecodeJsonCons2(/* @__PURE__ */ gDecodeJsonCons1({
  ...
  var FetchAndUpdatePeers = /* @__PURE__ */ function() {
    function FetchAndUpdatePeers2() {
    }
    ;
    FetchAndUpdatePeers2.value = new FetchAndUpdatePeers2();
    return FetchAndUpdatePeers2;
  }();
  var SetPeers = /* @__PURE__ */ function() {
    function SetPeers2(value0) {
      this.value0 = value0;
    }
    ;
    SetPeers2.create = function(value0) {
      return new SetPeers2(value0);
    };
    return SetPeers2;
  }();
  var peerHtml = function(peer) {
    return div_([h2_([text5("Peer: " + peer.name)]), p_([text5("Status: " + peer.data.status)]), p_([text5("Transfer: " + peer.data.transfer)])]);
  };
  var render = function(v) {
    return div_([div_(map24(peerHtml)(v.value0.peers))]);
  };
  ...
  var fetchPeers = /* @__PURE__ */ bind6(/* @__PURE__ */ get(driver)(json)("/peers"))(function(response) {
    if (response instanceof Left) {
      return pure10([]);
    }
    ;
    if (response instanceof Right) {
      var v = decodeJson2(response.value0.body);
      if (v instanceof Left) {
        return pure10([]);
      }
      ;
      ...
      ;
      throw new Error("Failed pattern match at Main (line 47, column 16 - line 49, column 36): " + [v.constructor.name]);
    }
    ;
    throw new Error("Failed pattern match at Main (line 45, column 3 - line 49, column 36): " + [response.constructor.name]);
  });
  var handleAction = function(dictMonadAff) {
    var liftAff2 = liftAff(monadAffHalogenM(dictMonadAff));
    return function(v) {
      if (v instanceof FetchAndUpdatePeers) {
        return bind15(liftAff2(fetchPeers))(function(peers) {
      ...
      ;
      throw new Error("Failed pattern match at Main (line 84, column 16 - line 89, column 64): " + [v.constructor.name]);
    };
  };
